...
public class PointSequence implements Comparable<PointSequence>{
    ...
    /**
     * I doubt if it works well because after Arrays.sort() there
     * is no duplicates
     * @return
     */
    ...
    public static void main(String[] args) {
    	...
    	p[5]=new Point(1,2);
    	*/
    	PointSequence ps = new PointSequence(p);
//    	System.out.println(ps.isOrdered());
    	System.out.println(ps.containsDuplicates());
